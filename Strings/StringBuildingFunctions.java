...
public class StringBuildingFunctions {
    ...
    private StringBuildingFunctions() {}
    ...
    // 8. Function to check if a string contains only digits (supports optional negative & decimal)
    ...
    public static void main(String[] args) {
        ...
        System.out.println("9. Random String: " + 
            generateRandomString(10)); // random string
